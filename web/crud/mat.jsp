...
<% 
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        String et = request.getParameter("etat").toString();
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Le numero materiel est exist deja");
            }
              %> 
        <script>   
            ...
            <div class="card-body">
              ...
              <form method="POST" action="#">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="numat" id="floatingInput" placeholder="num" required >
                        <label for="floatingInput">N° materiel</label>
                    </div>
                    <div class="form-floating mb-3">
                       <input type="text" class="form-control" name="des" id="floatingInput" placeholder="des" required >
                       <label for="floatingInput">Design</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="car" id="floatingInput" placeholder="car" required >
                  ...
                  <button type="submit" value="submit" name="submit" id="submit" class="btn btn-primary"><span><img src="../img/plus.png" width="25" height="height" alt="alt"/></span>Ajouter</button>
                </form>
            </div>
            </div>
            <div class="col-sm-8">
